 ...
 * This annotation defines concrete class as JSF {@link ClientBehavior}, or abstract class as the base for generated Behavior
 * implementation.
 * </p>
 *
...
public @interface JsfBehavior {
    String NAME = "org.richfaces.cdk.annotations.JsfBehavior";

    /**
     * <p class="changed_added_4_0">
     * behavior-id with which instances of implementation class can be created b JSF Application implementation. If this value
     * an empty, behavior-id will be inferred from class name.
     * </p>
     *
    ...
    /**
     * <p class="changed_added_4_0">
     * Renderer associated with generated {@link ClientBehavior}
     * </p>
     *
     * @return
     */
